   ...
   // --- Dados dos Planos de Assinatura ---
    const subscriptionPlansData = {
        firstLove: {
            ...
            plans: [
                { id: "fl_monthly", name: "Plano Mensal (Compra Única)", price: "R$ 69,90", description: "Uma única box, sem compromisso. Cobrança única.", type: "unique" },
        ...
        idolBox: { // Corresponde a 'K-BOXY Lover'
            ...
            plans: [
                { id: "il_monthly", name: "Plano Mensal (Compra Única)", price: "R$ 79,90", description: "Uma única box, sem compromisso. Cobrança única.", type: "unique" },
        ...
        legendBox: { // Corresponde a 'K-BOXY True Love'
            ...
            plans: [
                { id: "tl_monthly", name: "Plano Mensal (Compra Única)", price: "R$ 99,90", description: "Uma única box, sem compromisso. Cobrança única.", type: "unique" },
